...
public class SauceChart {
    ...
    public SauceChart(double mh, double stdh, double ms, double stds) {


        SauceAcceptableOverwipe aOver = new SauceAcceptableOverwipe();
        SauceAcceptableUnderwipe aUnder = new SauceAcceptableUnderwipe();
        SauceEvenSpread eSpread = new SauceEvenSpread();
        SauceRejectOverwipe rOver = new SauceRejectOverwipe();
        SauceRejectUnderwipe rUnder = new SauceRejectUnderwipe();
        ...
        chart = ChartFactory.createLineChart("Pizza Sauce Spread", "Statisticals Descriptors", "Categories", dataset, PlotOrientation.VERTICAL, true, true, false);
    }
